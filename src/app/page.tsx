            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="mb-8 md:mb-0">
                <Social
                  ...
                  iconStyle="w-9 h-9 border-2 border-accent rounded-full flex justify-center items-center text-accent text-base hover:bg-accent hover:text-primary hover:transition-all duration-500"
                />
              </div>
            </div>
          </div>
